...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      if (!rgba) {
        throw new Error("Required RGBA format is not supported.");
      }
      if (!dye) {
        dye = createDoubleFBO(
          dyeRes.width,
      ...
      if (!velocity) {
        if (!rg) throw new Error("Required RG format is not supported.");
      ...
      if (!r) {
        throw new Error("Required R format is not supported.");
      }
